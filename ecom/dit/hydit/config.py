...
def get_args(default_args=None):
    ...
    parser.add_argument("--model-root", type=str, default="/home/image_team/image_team_docker_home/lgd/EcommerceSD/weights/stable_diffusion/HunyuanDiT-v1.1/", help="Model root path.")
